...
class BlackListDefiner:
    ...
    def __init__(self) -> None:
        ...
        self.black_list_publisher = rospy.Publisher('/core/black_list', aura.msg.group, queue_size=1000)
        rospy.Subscriber('/core/add_to_black_list', aura.msg.data, self.get_black_list, queue_size=1000)
        self.black_list = []
        self.rate = rospy.Rate(10)
        self.publish_black_list()

    def get_black_list(self, point: aura.msg.data) -> None:
